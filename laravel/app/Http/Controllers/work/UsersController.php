  ...
  $users = User::select([
    ...
    ->addColumn('image', function($users) {
      ...
      ->addColumn('profile', function($users) {
        $update_confirmation          = '\'Do You Want to Update Prices ? \'';
          ...
          <a href="'.route('work.user.update_products',$users->id).'" class="btn btn-primary btn-xs" title="Update Products" onclick="return confirm('.$update_confirmation.');" ><i class="material-icons">swap_vertical_circle</i></a>';
              })
    ...
    ->addColumn('action', function($users) {
        $delete_confirmation          = '\'Do You Want to Delete '.$users->name.' ? \'';
                 ...
                 <a href="'.route('work.user.delete',$users->id).'" class="btn btn-danger btn-xs" title="Delete" onclick="return confirm('.$delete_confirmation.');" ><i class="material-icons">delete</i></a>';
                })
    ...
    {
        return view('work.user.create')->with('currencies',Currency::all());
    }
