...
class EbayController extends Controller
{
    ...
    public function edit_ebay()
    {
       // $site_settings = Setting::first();
       $crawler_ebay = CrawlerEbay::first();
        return view('work.crawl.ebay_affiliate')
         ->with ('crawler_ebay',$crawler_ebay);
    }
    ...
    $crawler_ebay = CrawlerEbay::first();
    $crawler_ebay-> affiliate_id = $request->affiliate_id;
  ...
  ///------------------------------Session-----------------------------///
    ...
    $affiliate_id          = $CrawlerEbay->affiliate_id;
    ...
    //
      ...
      // get affiliate url
      $product_affiliate_url = $affiliate_id.$product_original_url;
      $product_affiliate_url = str_replace('https://www.ebay.com/itm/','', $product_affiliate_url);
      // if (Product::where('original_url', '=',$product_original_url)->exists()&& !empty($ProductPrice)) {
      ...
      if (empty($product_name) || empty($product_original_url) || empty($product_affiliate_url) || empty($product_image) || empty($product_price)) {
      ///------------Session-----------///
