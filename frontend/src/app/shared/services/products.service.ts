...
export class ProductsService {
  ...
  */
  ...
  public getProductByCategory(category: string): Observable<Product[]> {
    var url = this.APIBASEURL + 'api/categoryChildProduct ';
    var dataToPost = {
      'slug': category,
    };
    return this.__httpClient.post(url, dataToPost, this.HEADERS).pipe(
  ...
  writeReview(product_id:number, user_id:number, rating:number, name:string, email:string, subject:string, message:string){
    const url = this.APIBASEURL + 'api/write_review';
    let dataToPost = {
